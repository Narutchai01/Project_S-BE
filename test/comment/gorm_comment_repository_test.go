...
func TestCreateComment(t *testing.T) {
	...
	t.Run("Create Comment Success", func(t *testing.T) {
		...
		mock.ExpectBegin()
		mock.ExpectQuery(regexp.QuoteMeta(`INSERT INTO "comments" ("created_at","updated_at","deleted_at","thread_id","user_id","favorite","text") VALUES ($1,$2,$3,$4,$5,$6,$7) RETURNING "id"`)).WillReturnRows(sqlmock.NewRows([]string{"id"}).AddRow(1))
		mock.ExpectCommit()
