...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/result/user/{userId}": {
            "get": {
                "description": "Get result by user ID",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/user/result": {
            "get": {
                ...
                "summary": "Get results by UserId from Token",
                "parameters": [
                    {
                        "type": "string",
        ...
        "/user/result/latest": {
            "get": {
                "description": "Get latest result by UserId from Token",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Get latest result by UserId from Token",
                "parameters": [
                    {
                        "type": "string",
                        "description": "User Bearer Token",
